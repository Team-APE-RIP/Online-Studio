...
import { Hoi4ProjectService } from "./hoi4-project.service";

@Controller("hoi4-projects")
export class Hoi4ProjectController {
  constructor(private readonly hoi4ProjectService: Hoi4ProjectService) {}
  ...
  async getOverview(): Promise<
    ...
    >
  > {
    const projects = await this.hoi4ProjectService.getOverview();
  ...
  async getFocusTrees(
    ...
    >
  > {
    const resources = await this.hoi4ProjectService.getFocusTrees(slug);
  ...
  async getLocalizations(
    ...
    >
  > {
    const resources = await this.hoi4ProjectService.getLocalizations(slug);
  ...
  > {
    const project = await this.hoi4ProjectService.getProjectDetail(slug);
